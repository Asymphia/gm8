...
export const mockDb = {
   ...
   announcements: [
      {
         id: 1,
         title: "Jutrzejsza inwentaryzacja",
         content: "Inwentaryzacja rozpoczyna się o 7:00.",
      ...
      {
         id: 2,
         title: "Zaktualizowana lista higieny",
         content: "Prosimy o zapoznanie się z nową procedurą.",
